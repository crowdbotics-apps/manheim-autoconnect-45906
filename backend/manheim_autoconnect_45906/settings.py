"""
Django settings for manheim_autoconnect_45906 project.
...
ROOT_URLCONF = 'manheim_autoconnect_45906.urls'
...
WSGI_APPLICATION = 'manheim_autoconnect_45906.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "manheim_autoconnect_45906 API",
    "DESCRIPTION": "API documentation for manheim_autoconnect_45906 App",
    "VERSION": "v1",
}
